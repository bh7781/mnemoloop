...
Claude Code querying a Linear MCP server to retrieve issue details for ticket MEN-12

Claude Code using the Context7 MCP server to look up the latest shadcn/ui documentation
