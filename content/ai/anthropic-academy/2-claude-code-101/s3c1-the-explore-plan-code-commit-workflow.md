---
id: claude-code-101-s3c1
course_name: Claude Code 101
section: Daily workflows
chapter: The Explore → Plan → Code → Commit Workflow
...
> **Note:** Quick tip: If you find Claude keeps running into the same issues, ask it to save the solution to its CLAUDE.md file.
