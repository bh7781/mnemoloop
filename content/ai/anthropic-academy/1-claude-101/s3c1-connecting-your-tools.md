...
The directory is organized into two tabs:
...
Navigate to claude.ai/directory, or click + > Connectors in any chat
...
Return to Claude and try a simple request, like:

> "Can you access my [tool name]?"
...
You can disconnect a service through Claude's settings or through the third-party service's security settings.

Just as with Skills, you can also find or build custom connectors. Exercise the same caution — only install connectors from trusted sources.
