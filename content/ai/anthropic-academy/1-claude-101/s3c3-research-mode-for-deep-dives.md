...
chapter: Research mode for deep dives
...
When you enable Research, you're activating an agentic, multi-step process that goes far beyond a simple web search.
...
Since Research can take 5 to 45 minutes depending on complexity, investing time in crafting your prompt pays off.
...
Claude will organize its findings around the structure you provide.
...
When using Research with integrations, you can steer Claude by saying things like:
